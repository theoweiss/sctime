...
#ifndef QCALENDARSYSTEMGREGORIAN_H
#define QCALENDARSYSTEMGREGORIAN_H
...
class QCalendarSystemGregorianPrivate;
 ...
 * @since 3.2
 */
class QCalendarSystemGregorian: public QCalendarSystem
{
public:
  QCalendarSystemGregorian ();
  virtual ~QCalendarSystemGregorian ();
